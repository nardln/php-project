...
<?php
	...
	$sql = "SELECT product_id, product_name, product_price, product_image, product_price_discount FROM products WHERE product_category = 'Hrana umeda pisici' OR product_category = 'Hrana uscata pisici' OR product_category = 'Accesorii pisici'";
...
<body>
	...
	<div id="content">
		...
		<div id="productsList">
			<h1 id="discounts">Produse pentru pisici</h1>
			<div id="list">
				<?php
