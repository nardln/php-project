...
<?php
	...
	$sql = "SELECT product_id, product_name, product_price, product_image, product_price_discount FROM products WHERE product_price_discount > 0";
...
<body>
	...
	<div id="content">
		...
		<div id="productsList">
			<h1 id="discounts">Produse la ofertă</h1>
			<div id="list">
				<?php
					if ($result -> num_rows > 0) { // If there are products with discounts...
	          while($row = $result -> fetch_assoc()) {
							...
							echo "<div class=\"product\">"
								 ...
								 . "	</div>"
								 . "	<div class=\"productName\"><a href=\"description.php?product_id=" . $row["product_id"] . "\">" . $row["product_name"] . "</a></div>"
