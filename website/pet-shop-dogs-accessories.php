...
<?php
	...
	$sql = "SELECT product_id, product_name, product_price, product_image, product_price_discount FROM products WHERE product_category = 'Accesorii caini'";
...
<body>
	...
	<div id="content">
		...
		<div id="productsList">
			<h1 id="discounts">Accesorii pentru câini</h1>
			<div id="list">
				<?php
