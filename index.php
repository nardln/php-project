	...
	<nav>
		...
		<div id="menuIcons">
			<div id="menuIconsWrapper">
				<img id="searchIcon" class="menuIconsColorFilter" src="res/search.svg">
				<img id="shoppingCartIcon" class="menuIconsColorFilter" src="res/shopping-cart.svg">
				<div id="userIconWrapper">
					<img id="userIcon" class="menuIconsColorFilter" src="res/user.svg">
